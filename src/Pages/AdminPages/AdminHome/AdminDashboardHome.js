    ...
    <div class="w-{90%]">
      ...
      <div>
        <div className="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-[#d46e08] text-3xl">Admin Name</h2>
            <div class="w-24 h-1 bg-[#d46e08]  rounded mt-2 mb-4"></div>
