  ...
  return (
    <div className='bg-black'>
      ...
      <div className="container mx-auto p-6">
        ...
        <h2 class="font-bold title-font text-[#d46e08] text-3xl mt-10"><Link to='/adminDashboardHome'><i class="fa-solid fa-circle-left text-3xl hover:scale-125"></i></Link> Cancle Booking</h2>
        </div>
          <table className="min-w-full divide-y divide-gray-200 mt-56 mb-56">
            <thead className="bg-gray-300 text-[#d46e08] shadow-2xl">
              <tr>
            ...
            <tbody className="bg-[#d46e08] divide-y divide-gray-500 rounded-2xl shadow-2xl">
              {bookings.map((booking, index) => (
                <tr key={index}>
                  <td className="px-6 py-4 border max-sm:p-1 text-xl text-black border-black  max-sm:text-sm text-center">
                    {booking.userID.Name}
                  </td>
