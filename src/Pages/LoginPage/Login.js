    ...
    <div>
      ...
      <section className='bg-black min-h-screen flex items-center justify-center'>
        <div className="container mx-auto px-4">
          <form className="lg:w-1/3 md:w-1/2 flex flex-col mx-auto w-full md:py-8 mt-8 md:mt-0" onSubmit={handleLogin}>
            <h2 className="text-[#d46e08] text-3xl mb-1 font-medium title-font mt-24 text-center">
              <i className="text-[#d46e08] fa-solid fa-user"></i> Login
            </h2>
            <p className="leading-relaxed mb-5 text-white text-center">Login Yourself here!</p>
            <input
              className="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base py-2 mb-4"
              placeholder="Email"
              type="email"
              value={Email}
            ...
            <p className="leading-relaxed mt-5 text-white text-center">If you don't have an account then Register here!</p>
